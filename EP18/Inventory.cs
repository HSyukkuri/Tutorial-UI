    ...
    public void UseItem(int index) {
        ...
        switch (itemList[index].data.GetType().ToString()) {
            ...
            case nameof(KeyItemData): {
                    ...
                    if(main.currentRoom.data == keyItemData.targetRoom) {
                        //鍵を使える！
                        main.currentRoom.desc = keyItemData.descOverride;
                        main.currentRoom.connectedRoomList = keyItemData.connectedRoomOverride;
